...
public class StudentDAO {
    public static boolean addStudent(Student ob)
    {
        ...
        try
        {
            ...
            String sql="INSERT INTO STUDENT(S_NAME,S_DEPT, S_PASSINGYEAR ,S_ADDRESS,S_DOB) VALUES(?,?,?,?,?)";
    ...
    public static boolean updateStudent(int op,int id,String updateVal){
        ...
        {
            String sql="UPDATE STUDENT SET S_DEPT = ? WHERE S_ID = ?";
        ...
        {
            String sql="UPDATE STUDENT SET S_PASSINGYEAR = ? WHERE S_ID = ?";
        ...
        {
            String sql="UPDATE STUDENT SET S_ADDRESS = ? WHERE S_ID = ?";
        ...
        {
            String sql="UPDATE STUDENT SET S_DOB = ? WHERE S_ID = ?";
